...
/**
*
* Reducer used by all inner hierarchy levels. Same functionality as SelectionReproductionReducer but
* also scores individuals for the next generation.
*/
	...
	protected ScoredChromosome makeOffspring(ArrayList<ScoredChromosome> parentPool)
		...
		try {
			...
			log.debug(String.format("PARENT 1: chromosome: %s, score: %g, accnormscore: %g",
					parent1.chromosome, parent1.score, parent1.accumulatedNormalizedScore));
			log.debug(String.format("PARENT 2: chromosome: %s, score: %g, accnormscore: %g",
					parent2.chromosome, parent2.score, parent2.accumulatedNormalizedScore));
